...
embedding_model_path = 'models/allminilm-finetuned-500-3'
###################################
...
available_collections = ['Huberman_minilm_512_finetune', 'Huberman_minilm_128', 'Huberman_minilm_256', 'Huberman_minilm_512']
...
def main(retriever: WeaviateWCS):
    ...
    #################
    with st.sidebar:
        collection_name = st.selectbox('Collection Name:', options=available_collections, index=0, placeholder='Select Collection Name')
    ...
    ##### SETUP MAIN DISPLAY #####
    ##############################
    st.image('src/app_assets/hlabs_logo.png', width=400)
    ...
    if query:
        ...
        token_threshold = token_threshold # generally allows for 3-5 results of chunk_size 256
        ...
        with st.spinner('Generating Response...'):
            ...
            if make_llm_call:
                with st.chat_message('Huberman Labs', avatar='src/app_assets/huberman_logo.png'):
